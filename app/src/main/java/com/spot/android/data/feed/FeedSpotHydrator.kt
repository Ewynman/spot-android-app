...
/**
 * Hydrates feed rows into UI [Spot] models with signed image URLs and session flags.
 */
@Singleton
class FeedSpotHydrator @Inject constructor(
    ...
    suspend fun hydrate(
        ...
        val base = SpotMapper.fromHomeFeedRow(row)
    ...
    private suspend fun resolveImageUrl(row: HomeFeedRowDto): String? {
